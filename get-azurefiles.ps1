...
# outputpath. To use the script, change set the directory full name with a end of "\". 
# sample: .\get-azurefles.ps1 -outputpath c:\windows\temp\
# if no parameter input, the output file will be stored in c:\windows\temp\ by default. 
# the output file contains file lists in each file share and file list in each blob. 
# author: simonin@microsoft.com
# time: 2018-6-18
